...
def generate_layout_nodes():
    ...
    spots[(-1.5, 3.0)]  = ('spot_01', 'PARKING_SPOT', '메인 창고 1행 1열', 3.0)
    spots[(-3.0, 3.0)]  = ('spot_02', 'PARKING_SPOT', '메인 창고 1행 2열', 3.0)
    spots[(-1.5, 0.0)]  = ('spot_03', 'PARKING_SPOT', '메인 창고 2행 1열', 0.0)
    spots[(-3.0, 0.0)]  = ('spot_04', 'PARKING_SPOT', '메인 창고 2행 2열', 0.0)
    spots[(-1.5, -3.0)] = ('spot_05', 'PARKING_SPOT', '메인 창고 3행 1열', -3.0)
    spots[(-3.0, -3.0)] = ('spot_06', 'PARKING_SPOT', '메인 창고 3행 2열', -3.0)
    spots[(-1.5, -6.0)] = ('spot_07', 'PARKING_SPOT', '메인 창고 4행 1열', -6.0)
    spots[(-3.0, -6.0)] = ('spot_08', 'PARKING_SPOT', '메인 창고 4행 2열', -6.0)
    spots[(-1.5, -9.0)] = ('spot_09', 'PARKING_SPOT', '메인 창고 5행 1열', -9.0)
    spots[(-3.0, -9.0)] = ('spot_10', 'PARKING_SPOT', '메인 창고 5행 2열', -9.0)
